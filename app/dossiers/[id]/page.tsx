...
import { Loader2, ChevronLeft, Car, User, Wrench, BadgeEuro, Play, CheckCircle, X } from "lucide-react";
          ...
          <div className="space-y-1">
            ...
            {estimatedPrice && Number(amount) !== estimatedPrice && (
              <p className="text-xs text-amber-500 font-medium px-1">
                Estimation initiale : {estimatedPrice} €
              </p>
            )}
          </div>
...
export default function DossierDetailPage() {
  ...
  /* Démarrer le travail : pending → in_progress */
  ...
  /* Clôturer : in_progress → done + paiement */
