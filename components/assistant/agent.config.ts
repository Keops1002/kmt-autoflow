...
export const AGENTS: AgentConfig[] = [
...
},
  {
    ...
    fields: [
      ...
      { key: "message", label: "Message à transmettre", type: "textarea", placeholder: "Ex: Voiture prête, freins changés, montant 180€" },
  ...
  fields: [
    ...
    { key: "infos_garage", label: "Infos du garage à communiquer", type: "textarea",
      placeholder: "Ex: Horaires lun-ven 8h-18h, adresse 12 rue des Acacias, spécialisé toutes marques..." },
