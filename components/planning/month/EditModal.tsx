...
import { daysBetween } from "./monthHelpers";
...
export default function EditModal({ bar, onSave, onClose }: Props) {
      ...
      >
        ...
        <div className="px-6 py-5 flex items-center justify-between rounded-t-3xl"
          ...
          <div>
            ...
            <h3 className="text-white font-black text-lg mt-1">{bar.dossiers?.problem}</h3>
